...
import com.openclassrooms.mediscreenpatient.exception.ConflictException;
import com.openclassrooms.mediscreenpatient.exception.NotFoundException;
...
public class RestExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleNotFound(final ConflictException exception) {
        final ErrorResponse errorResponse = new ErrorResponse();
